...
import com.RESTTutorial.exceptions.OrderNotFoundException;
...
public class OrderController {
  ...
  ResponseEntity<?> cancel(@PathVariable Long id) {
    ...
    return ResponseEntity
        ...
        .body(Problem.create()
            .withTitle("MethodNotAllowed")
            .withDetail("You can't cancel an order that is in the " + order.getStatus().toString() + " status") );
  }
  ...
  ResponseEntity<?> complete(@PathVariable Long id) {
    ...
    return ResponseEntity
        ...
        .body(Problem.create()
            ...
            .withDetail("You can't complete an order that is in the " + order.getStatus().toString() + " status"));
  }
